...
<template>
  <q-card class="   shadow-5"
    style="border-radius: 10px; background-image: url('/src/img/programas/bg-02.png'); background-size: cover;"
    :class="ui.device === 'smartphone' ? 'col-12 q-pl-md q-pr-md q-pt-md q-pb-sm' : 'col-5 q-pl-xl q-pr-xl q-pt-lg q-pb-lg'">

    <q-card-section horizontal>
      <q-img spinner-color="primary" class="col-4 imagen-cover-curso" :src="thumb" style="border-radius: 0; "></q-img>
      <q-card-section class="q-pl-lg q-pt-none q-pr-none full-width q-pb-lg justify-between column" style="gap:10px">
        ...
        <q-btn flat color="white" class="bg-primary full-width q-mb-sm" v-if="!comprar"
          @click="abrir_pago(url_compra)">Comprar</q-btn>
        <q-btn flat color="white" class="bg-primary full-width q-mb-sm" v-else
          v-on:click="cargarCurso(props.id)">Ingresar</q-btn>
      </q-card-section>
